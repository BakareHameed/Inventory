...
<h2>Dear Support,</h2>
<p style="color:black">
    This is to notify you that the client, <strong> {{$client}}</strong>,<br>
    located at, <strong> {{ $address}},</strong> has just been handed over to
    your department.<br><br><strong>Kindly login to the ERP for further details relating to the client.</strong><br><br>
