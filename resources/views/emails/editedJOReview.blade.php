...
<h2>Dear {{ $details['editor'] }},</h2>
<p style="color:black">{{  $details ['comment']  }}
</p>
...
<strong style="color:brown">Email:</strong> <strong><em style="color:blue;font-family: Georgia, serif;"> serviceoperation@syscodescomms.com</em></strong> <br> 
