<form class="form-group" action="{{url('update_radio_param',$client->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="Update{{$client->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Update{{$client->id}}Label" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="Update{{$client->id}}Label"><span style="color:blue;align:right"><strong >Update Client's Link Information<strong></span></h1>
            ...
            <div class="modal-body">
                <div class="row mt-5 ">
                    <div class="form-group name2 col-md-6">
                        ...
                        <input type="text" disabled value="{{$client->clients}}" 
