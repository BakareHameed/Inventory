...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-success shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. of Active SME Clients</div>
 ...
 <div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1" > Total No. of Active Home Clients </div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-info shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. of Active Dedicated clients </div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"> {{$Dedicated}} </div>
        </div>
        <div class="col-auto">
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          ...
          <div class="text-lg font-weight-bold text-danger text-uppercase mb-1"> Total Inactive clients</div>
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          ...
          <div class="text-lg font-weight-bold text-danger text-uppercase mb-1"> Total Inactive SME clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"> {{$Inactive_SME_clients}} </div>
        </div>
        <div class="col-auto">
          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
        </div>
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          ...
          <div class="text-lg font-weight-bold text-danger text-uppercase mb-1"> Total Inactive Home clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"> {{$inactive_home_clients}} </div>
        </div>
        <div class="col-auto">
          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
        </div>
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          ...
          <div class="text-lg font-weight-bold text-danger text-uppercase mb-1"> Total Inactive Dedicated clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"> {{$inactive_Dedicated}} </div>
        </div>
        <div class="col-auto">
          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
        </div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-info shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-ash text-uppercase mb-1"> Total No. of Suspended clients </div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"> {{$suspended_customers}} </div>
        </div>
        <div class="col-auto">
          <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
        </div>
