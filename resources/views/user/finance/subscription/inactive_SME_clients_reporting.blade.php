...
<!--End of Multi-Level Navbar -->
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    ...
    <h2 style="font-size:20px">Get Inactive SME Customers Between:</h2>
 ...
 <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. Inactive SME Clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800">{{$no_inactive_SME_reporting}} </div>
        </div>
        <div class="col-auto">
      ...
      <tr style="background-color:black;">
        ...
        @endif
			...
			@foreach($inactive_SME_reporting as $appointment)
        <tr style="background-color: #e8dbca;" align="left">
          ...
          @endif
          @if(Auth::user()->role=='Finance Officer')
            <td style="padding: 5px; color: black;">{{$appointment->activation_date}}</td>
