      ...
      <table border=1 align='left' style="margin-bottom: 50px">
            ...
            @foreach($suspended_customers as $suspended_customers)
              <tr style="background-color: #e8dbca;" align="left">
                  ...
                  <td style="padding:  20px; color: black;">{{$suspended_customers->id}}</td>
                  <td style="padding:  20px; color: black;">{{$suspended_customers->clients}}</td>
                  <td style="padding:  20px; color: black;">{{$suspended_customers->phone}}</td>
                  <td style="padding:  20px; color: black;">{{$suspended_customers->address}}</td>
                  <td style="padding:  20px; color: black;">{{$suspended_customers->service_plan}}</td>
                  <td style="padding:  20px; color: black;">{{$suspended_customers->service_type}}</td>
                  @if($suspended_customers->status=='Active')
                  <td style="padding:  20px; color: black;  background-color: #8febab">{{$suspended_customers->status}}</td>
                  @elseif($suspended_customers->status=='Inactive')
                  <td style="padding:  20px; color: black;  background-color: yellow">{{$suspended_customers->status}}</td>
                  @else
                  <td style="padding:  20px; color: black;  background-color: #fc6d6d ">{{$suspended_customers->status}}</td>
                  @endif
                @endforeach
              </tr>
      </table>      	
