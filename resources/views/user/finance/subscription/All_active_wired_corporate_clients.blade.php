...
<body>
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    ...
    <h2 style="font-size:20px">Get Active Wired Corporate Customers Between:</h2>
    <form class="main-form" action="{{url('wired_corporate')}}" method="GET" enctype="multipart/form-data">
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">All Active Wired Corporate Clients</h1>
    </div>
</div>
      ...
      <th style="padding:5px; font-size: 20px; color: white ;">S/N</th>
        ...
        <th style="padding:5px; font-size: 20px; color: white ;">Service Type</th>
         ...
         <th style="padding:5px; font-size: 20px; color: white ;">Status</th>
			...
			@foreach($wired_corporate as $appointment)
