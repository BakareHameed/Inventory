...
<html lang="en">
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    ...
    <h2 style="font-size:20px">Get Active Home Customers Between:</h2>
 ...
 <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. Active Home Clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800">{{$no_active_home}} </div>
        </div>
        <div class="col-auto">
      ...
      <th style="padding:5px; font-size: 20px; color: white ;">Status</th>
        ...
        @endif 
			...
			@foreach($active_home as $appointment)
