...
<html lang="en">
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    ...
    <h2 style="font-size:20px">Get Active SME Customers Between:</h2>
 ...
 <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. Active SME Clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800">{{$no_active_SME_reporting}} </div>
        </div>
        <div class="col-auto">
      ...
      <th style="padding:5px; font-size: 20px; color: white ;">S/N</th>
        ...
        @endif
			...
			@foreach($active_SME_reporting as $appointment)
