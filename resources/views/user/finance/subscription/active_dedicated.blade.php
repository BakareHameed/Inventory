...
<html lang="en">
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <span>
    <h2 style="font-size:20px">Get Active Postpaid Customers Between:</h2>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">All Active Postpaid Clients</h1>
    </div>
</div>
 ...
 <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. Active Postpaid Clients</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800">{{$no_active_Dedicated_clients}} </div>
        </div>
        <div class="col-auto">
      ...
      <th style="padding:5px; font-size: 20px; color: white ;">S/N</th>
        ...
        @endif
			...
			@foreach($active_Dedicated_clients as $appointment)
