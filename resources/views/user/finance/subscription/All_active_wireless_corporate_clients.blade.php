...
<body>
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    ...
    <h2 style="font-size:20px">Get Active Wireless Corporate Customers Between:</h2>
    <form class="main-form" action="{{url('wireless_corporate')}}" method="GET" enctype="multipart/form-data">
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">All Active Wireless Corporate Clients</h1>
    </div>
</div>
    ...
    <div class="card-body">
      ...
      <div align="left" style="padding-right:30px;padding-top:30px">
        ...
        @endif
			...
			@foreach($wireless_corporate as $appointment)
