...
<!--End of Multi-Level Navbar -->
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">All Inactive SME Clients</h1>
    </div>
</div>
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          ...
          <div class="h5 mb-0 font-weight-bold text-gray-800">{{$no_inactive_SME_clients}} </div>
        </div>
        <div class="col-auto">
      ...
      <div align="left" style="padding-right:30px;padding-top:30px">
        ...
        @endif
			...
			@foreach($inactive_SME_clients as $appointment)
