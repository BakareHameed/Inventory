...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get Inactive Customers Between:</h2>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">All Inactive Clients</h1>
    </div>
</div>
...
<div >
    ...
    <div align="left" style="padding-left:20px;padding-top:30px:margin-bottom: 30px;">
      <table border=1 align='left' style="margin-bottom: 50px">
            ...
            @foreach($total_customers as $Inactive_cust)
