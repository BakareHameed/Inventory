<div class="modal fade" id="View{{$report->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Raise{{$report->id}}Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="View{{$report->id}}Label"><span style="color:blue;align:right"><strong>Job Completion Report<strong></span></h1>
