...
<html lang="en">
    ...
    <body>
                ...
                <div class="-my-0 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-0 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="py-0 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div align="right">    
                                <span>
                                    <a style="padding: 10px;margin-bottom:5px" class="btn btn-outline-info" href="{{ route('engr.completed.pop.survey') }}">All Completed</a>
                                </span>
                                {{-- <span>
        ...
        @foreach($popSurveys as $survey)
            @include('user.field_engineer.POP.form.survey')
        @endforeach
        ...
        <script type="text/javascript">
           function feasPOPs(that){ 
            var popfeas = document.getElementById('POPfeas');
            if(that.value == "Yes"){
                popfeas.style.display="block";
            }
            else{
                popfeas.style.display = "none"
            }
           }
        </script>
    </body> 
