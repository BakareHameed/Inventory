    ...
    <div class="bg-light">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 py-3 wow fadeInUp">
                        ...
                        <p class="text-grey mb-4">Our Broadband services covers Internet Service Positioning, Virtual
                            Private Network and Communication Systems Integration namely microwave wireless systems,
                            optic fiber installation and provision of last mile connectivity.</p>
        ...
        <footer class="page-footer">
            <div class="container">
                ...
                <p id="copyright">Copyright &copy; 2021 <a href="https://macodeid.com/" target="_blank">MACode
