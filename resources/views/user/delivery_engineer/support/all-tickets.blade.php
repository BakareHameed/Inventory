                                        ...
                                        <tr style="background-color: white;" align="left">
                                            ...
                                            @elseif($ticket->status =='In Progress' || $ticket->status =='Assigned' || $ticket->status =='Reassigned' )
                                                ...
                                                <td style="padding: 5px; color: black;" >
                                                    ...
                                                    <a style="padding: 10px;margin-bottom:5px;background-color:darkviolet" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#Reassign{{$ticket->ticket_id}}">
                                                        Reassign
                                                    </a>
                                                </td>
