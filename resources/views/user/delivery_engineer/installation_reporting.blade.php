...
<body>
  ...
  <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
      <span>  
            <h2>Get Installation Done:</h2>
            <form class="main-form" action="{{url('installation_reporting')}}" method="GET" enctype="multipart/form-data">
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        Installations carried out between 
...
<div  class="col-lg-6 py-3 wow fadeInUp text-center" style ='position:absolute; left:1030px; top:400px'>
        <a class='btn btn-sm btn-primary' href="{{url('delivery_installation_export/' . $dateS. '/' . $dateE .'')}}">
            Download Excel
        </a>
</div>
      ...
      <div align="Center" style="padding-left:10px;padding-bottom:30px">
        ...
        <th style="padding:10px; font-size: 20px; color: white ;">Survey Report</th>
			...
			@foreach($installation_reporting as $appointment)

			<tr style="background-color: white" align="center">
            <td>{{$loop->iteration}}</td>
            <td style="padding: 10px; color: black;">{{$appointment->customer_id}}</td>
