          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <!-- <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">View Charts</a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  <h6 class="p-3 mb-0">Charts</h6>
                  ...
                  <a class="dropdown-item preview-item" href="{{url('weekly_survey_graph')}}">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Weekly Survey Report</p>
                    </div>
                  </a>
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="{{url('shared_service_chart')}}">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Shared Service Customers</p>
                    </div>
                  </a>
