...
<div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h3 class="text-center" style="text-align:center:">Search result for Survey Request</h3>
    </div>
</div>
      ...
      <div align="Center" style="padding-left:30px;padding-bottom:30px">
        ...
        <th style="padding:10px; font-size: 20px; color: white ;">Save</th>
      ...
      <td style="padding: 10px; color: black;">{{$appointment->third_assigned_engr}}</td>
        ...
        <td><a class="btn btn-primary" href="{{url('assign_engr_form',$appointment->id)}}">Assign Engineer</a></td>

        <td><a class="bt btn-danger" onclick="return confirm('Are you sure that you want to delete this survey?')" href="{{url('cancel_appoint',$appointment->id)}}">Delete</a></td>
