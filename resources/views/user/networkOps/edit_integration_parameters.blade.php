...
@endif
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center"> Edit Integration Parameters</h1>
    </div>
</div>
...
<form class="main-form" action="{{url('edit_integration_param',$data->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
            <input type="number" min="4" max="10000" name="vlan_id" value="{{ old('vlan_id', $data->vlan_id) }}" class="form-control" placeholder="VLAN ID">
          </div>

          <div class="col-12 col-sm-6 py-2 wow fadeInRight">
            <input type="text" name="ip_address" value="{{ old('ip_address', $data->ip_address) }}"  class="form-control" placeholder="IP Address">
          </div>
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <input type="text" name="gateway" value="{{ old('gateway', $data->gateway) }}" class="form-control" placeholder="GATEWAY">
          </div>

          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
            <input type="text" name="queue_name" value="{{ old('queue_name', $data->queue_name) }}" class="form-control" placeholder="Queue Name">
          </div>

          <div class="col-12 py-2 wow fadeInLeft" data-wow-delay="300ms">
          <select required name="device_type" value="{{ old('device_type', $data->device_type) }}" class="block  mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 form-control" >
