...
<form class="main-form" action="{{url('industry_change_form',$data->id)}}" method="POST" >
    @csrf
    ...
    <div class="col-12 py-2 wow fadeInLeft" data-wow-delay="300ms">
        <input disabled type="text"  value="Industry:{{ old('amount_paid', $data->Industries) }}" id="amount_paid" class="form-control" placeholder="Total amount paid..." required>
    </div>

    <div class="col-12 py-2 wow fadeInRight" data-wow-delay="300ms">
        <input disabled type="text" value="Industries Category:{{ old('date', $data->Industries_sub_cat) }}" class="form-control" placeholder="date of payment..." required>
    </div>
    ...
    <div class="col-12 col-sm-6 py-2 wow fadeInRight" >
        <select onchange="QuoteCheck(this);" id="quote" name="change" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 main-form" >
            <option>--- Change Industry Category?---</option>
            <option>Yes</option>
            <option>No</option>
        </select>
    </div>
    ...
    <div id="ifQuoteYes" style="display: none;">
      <div id="quote_amount" >
        <form class="main-form" action="{{url('industry_change_form')}}" method="POST" enctype="multipart/form-data">
        ...
        <select onchange="planCheck(this);" id="service_plan" name="Industries_sub_cat[]"class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 main-form" >
            ...
            <option>Electronics/Equipments/Sales/Support services</option>
            ...
            <!-- <option>HOME</option> -->
            <option>ICT/IT</option>
            <!-- <option>IT</option> -->
            <option>LAW </option>
            <!-- <option>Manufacturing </option> -->
            <!-- <option>MEDIA/ADVERTISING</option> -->
            <option>MEDIA/ADVERTISING/PHOTOGRAPHY</option>
