...
<div class="row">
      ...
      <div align="left" style="padding-left:30px;padding-top:30px;padding-bottom:30px">
        ...
        <tr style="background-color:black;">
            ...
            <th style="padding:5px; font-size: 20px; color: white ;text-alignment:left">Pending Businesses</th>
        ...
        <tr style="background-color: skyblue;" align="left">
            ...
            <td style="padding: 3px; color: black;">{{$marketers->count}}</td>
            ...
            <td style="padding: 3px; color: black;" >₦{{number_format($marketers->MRC)}}</td>
            <td style="padding: 3px; color: black;" >₦{{number_format($marketers->OTC)}}</td>   
            <td style="padding: 3px; color: black;" >
            <a class="btn btn-primary" style ="Background-color:#630d34;font-family:Lorem ipsum dolor sit amet;font-size:20px" href="{{url('pend_bus_details',$marketers->id)}}">View</a>
            </td>
        </tr>
