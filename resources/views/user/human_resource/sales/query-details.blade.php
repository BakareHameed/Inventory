                                ...
                                <table class="shadow overflow-hidden sm:rounded-lg  text-sm text-gray-400">
                                    <thead class="bg-gray-800 text-xs uppercase font-medium">
                                        <tr style="background-color:black;">
                                            ...
                                            <th style="padding:5px; font-size: 20px; color: white ;">
                                                Sent By</th>
                                            <th style="padding:5px; font-size: 20px; color: white ;">
                                                Company</th>
                                            <th style="padding:5px; font-size: 20px; color: white ;">
                                    ...
                                    <tbody>
                                        @foreach ($details as $detail)
                                            <tr style="background-color: #fff;" align="left">
                                                ...
                                                <td style="padding: 3px; color: black;">{{ $detail->contact_name }}</td>
                                                <td style="padding: 10px; color: black;">{{ $detail->service_type }}
                                                </td>
                                                ...
                                                {{-- <td style="padding: 3px; color: black;" >
                                      <a style="padding: 10px;margin-bottom:5px" class="btn btn-danger" href="{{route('hr.detail.delete',$detail->id)}}">Delete</a><span>
                                  </td> --}}
                                            </tr>
                                        @endforeach
                                    </tbody>
