        ...
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              ...
              <a href="#"><span class="mai-mail text-primary"></span> syscodescomms.</a>
            </div>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <li><a class="dropdown-item" href="{{url('ready_links')}}">Links Ready for Deployment</a></li>
                  <li><a class="dropdown-item"  href="{{url('delivery_table')}}">Create New Base Station</a></li>
                  <li><a class="dropdown-item" href="{{url('assigned_survey')}}">All Base Stations</a></li>
