<form class="form-group" action="{{url('edit_radio_param',$client->radio_id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="Edit{{$client->radio_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Edit{{$client->radio_id}}Label" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="Edit{{$client->radio_id}}Label"><span style="color:blue;align:right"><strong >Edit Client's Link Information<strong></span></h1>
