...
<body>
    ...
    <div align="Center" style="padding:0px">
        ...
        <h1 class="text-center" style="text-align:center;font-size:2rem">
            All {{$status}} Clients In {{$QueriedPOP}} POP 
        </h1>
        </div>
    </div>
    ...
    <div class="container pb-3" align="center" style="padding-top: 5px;">
        <div class="row ml-3">
         ...
         @include('user.support.customers.subscriptionStatus.statusStatement.status')
