...
@include('user.support.head')
    <body>
        ...
        <div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
            ...
            <form class="main-form" action="{{route('my.dailyHandover.query')}}" method="GET" enctype="multipart/form-data">
              @csrf
                    <div class="container">
                    <div class="row">
        ...
        <div align="center" style="padding:0px">
            <div class="col-md-12 py-3 wow fadeInUp text-center" >
                <h1 class="text-center" style="text-align:center;font-size:2rem">
                 All {{ $userName }} Daily Handovers From <b>{{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}</b>
                  to <b>{{Carbon\Carbon::parse($dateE)->format('D, M j, Y')}}</b>
                </h1>
            </div>
        </div>
                            ...
                            <div class="">
                                <table  class="shadow overflow-hidden sm:rounded-lg  text-sm text-gray-400">
                                    <div align="right">    
                                        ...
                                        <span>
                                            <a style="padding: 10px;margin-bottom:5px" class="btn btn-outline-primary" href="{{ route('support.dailHandover.add')}}" >Daily Handove</a>
                                        </span>
                                        <span>
                                            <a style="padding: 10px;margin-bottom:5px" class="btn btn-outline-info" href="{{route('my-handover.send')}}" > send</a>
                                        </span>
                                    </div>
                                    ...
                                    <tbody>
                                        @foreach($dailyHandovers as $dailyHandover)
                                            <tr style="background-color: white;" >
                                                ...
                                                <td> 
                                                    <a style="padding: 3px;margin-bottom:5px" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#EdidDailyHandover{{$dailyHandover->id}}">Edit</a>
