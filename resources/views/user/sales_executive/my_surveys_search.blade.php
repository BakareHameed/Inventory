...
<body>
  ...
  <div class="col-sm-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">Get survey Between:</h1>
  </div>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:20px">
            @if (count($surveys) > 0)
                {{count($surveys)}} result(s) found for my surveys
            @else
                No result found
            @endif
       </h1>
...
<div class="container" align="text-left" style="padding-top: 5px;">
...
@endif
      ...
      <div align="center" style="padding-right:20px;margin: 15px">
