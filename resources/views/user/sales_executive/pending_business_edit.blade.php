...
@endif
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center; font-size: 30px">Edit Pending Business</h1>
    </div>
</div>
...
<form class="main-form" action="{{url('pending_business_edit',$data->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
          <input type="text" name="company_name" value="{{ old('company_name', $data->company_name) }}"  class="form-control" placeholder="Company Name">
           </div>

          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
          <input type="text" name="contact_name" value="{{ old('contact_name', $data->contact_name) }}"  class="form-control" placeholder="Contact Name">
           </div>

           <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
           <input  type="text" name="contact_number"  value="{{ old('contact_number', $data->contact_number) }}"   class="form-control" Placeholder=" Contact Number"> 
           </div>
           
           <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
          
          <input type="email" name="email" value="{{ old('email', $data->email) }}"  class="form-control" placeholder="Email">
        </div>

        
        <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
            <input type="text" name="location" value="{{ old('location', $data->location) }}"  class="form-control" placeholder="Location">
          </div>
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
                <input type="text" name="competitors" value="{{ old('competitors', $data->competitors) }}"  class="form-control" placeholder="Competitors">
          </div>

          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
                <input type="text" name="selling_advantage" value="{{ old('selling_advantage', $data->selling_advantage) }}"  class="form-control" placeholder="Selling Advantage">
          </div>
          ...
          <select required onchange="QuoteCheck(this);" id="quote" name="quote" value="{{ old('quote', $data->quote) }}" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 main-form" >
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <textarea name="remark" id="comment" value="{{ old('remark', $data->remark) }}" class="form-control" rows="6" placeholder="Any remark on this pending?"></textarea>
          </div>
