...
<body>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:30px">Surveys Raised For    {{Carbon\Carbon::parse($Currentdate)->format(' F,Y')}} </h1>
    </div>
</div>
  ...
  <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      ...
      <div align="Center" style="padding-left:30px;padding-bottom:30px">
        ...
        <th style="padding:10px; font-size: 20px; color: white ;">Duration(Hours) </th>
        ...
        <tr style="background-color: white" align="center">
          ...
          @if($appointment->duration_hours === null)
          <td style="padding: 10px; color: black;">{{$appointment->duration_hours}}</td>
          @else
          <td style="padding: 10px; color: black;">{{$appointment->duration_hours}} Hours</td>
          @endif
          <td style="padding: 10px; color: black;">{{$appointment->duration_human}}</td>
