...
<body>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:30px">Surveys Done By  Engineer {{$engr_name}} </h1>
    </div>
</div>
...
<div align="right" style="margin-left:40rem" class="col-lg-3 py-3 wow fadeInUp text-center" >
        <div style="margin-bottom:5px">
            <h1 class="text-right" style="text-align:right;font-size:1.5rem">Filter By Engineer:</h1>
        </div>
        <form class="main-form" action="{{url('engr_filter_reporting/' . $dateS. '/' . $dateE .'')}}" method="GET" enctype="multipart/form-data">

              @csrf
            <div style="margin-bottom:5px">
              <select name="engr_name"name="pop" class="block  mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 form-control" >
                  <option value="">---select Engineer---</option>
                 @foreach($engineers as $engineers)
                  <option value="{{$engineers->engr_name}}" name="engr_name">{{$engineers->engr_name}}</option>
               @endforeach 
                 </select>
            </div>
      ...
      <div align="left" style="padding:10px;margin-bottom:30px;margin: 15px;">
        ...
        <tr style="background-color: white" align="center">
            ...
            @endif
            <td style="padding: 10px; color: black;">{{$appointment->engr_name}}</td> 
