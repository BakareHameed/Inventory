            ...
            <div>
                ...
                <select
                    ...
                    >
                        ...
                        <option>Delivery Engineer</option>
                        <option>Field Engineer</option>
                        <option>Fibre Engineer</option>
                        <option>Finance Officer</option>
                        <option>Human Resources</option>
                        <option>IT Operation</option>
                        <option>Network Operation Engineer</option>
                        ...
                        <option>Service Support Analyst</option>
                        <option>Service Support Engineer</option>
