                    ...
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                            <a href="{{url('government')}}" style="font-size:30px" class="btn btn-primary">
                                <strong>View</strong>
                            </a>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success " >
                            <a href="{{url('multinational')}}" style="font-size:30px" class="btn btn-primary">
                               <strong>View</strong>
                            </a>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success">
                            <a href="{{url('p_business')}}" style="font-size:30px" class="btn btn-primary">
                                <strong>View</strong>
                            </a>
                        </div>
                        <div class="icon icon-box-success" style="margin-top:30px">
                            <a href="{{url('pb_industries')}}" style="font-size:30px" class="btn btn-primary">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success " >
                            <a href="{{url('cybercafe')}}" style="font-size:30px" class="btn btn-primary">
                                <strong>View</strong>
                            </a> 
                        </div>                
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success " >
                            <a href="{{url('hm_research')}}" style="font-size:30px" class="btn btn-primary">
                                <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="icon icon-box-success " >
                            <a href="{{url('public_lib')}}" style="font-size:30px" class="btn btn-primary">
                                <strong>View</strong>
                             </a> 
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('pub_sec_ser')}}" style="font-size:30px" class="btn btn-primary">
                               <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('ngo')}}" style="font-size:30px" class="btn btn-primary">
                            <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('sch_res')}}" style="font-size:30px" class="btn btn-primary">
                              <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('institution')}}" style="font-size:30px" class="btn btn-primary">
                            <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('res_indi')}}" style="font-size:30px" class="btn btn-primary">
                            <strong>View</strong>
                            </a> 
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('military')}}" style="font-size:30px" class="btn btn-primary">
                            <strong>View</strong>
                            </a>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class= "icon icon-box-danger" >
                            <a href="{{url('others')}}" style="font-size:30px" class="btn btn-primary">
                              <strong>View</strong>
