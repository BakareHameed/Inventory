...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Active Retail Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Retail Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total Active Retail Clients</div>
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($active_home as $active_home)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$active_home->customer_id}}</td>
                    <td style="padding: 10px; color: black;">{{$active_home->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$active_home->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$active_home->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$active_home->created_at}}</td>
                    @if($active_home->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$active_home->status}}</td>
                    @elseif($active_home->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$active_home->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$active_home->status}}</td>
                    @endif
