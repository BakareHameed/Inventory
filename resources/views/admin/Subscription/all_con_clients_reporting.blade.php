...
<!--End of Multi-Level Navbar -->
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Connected Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
          ...
          <table border=1 align='center'  style= "margin-bottom: 50px;">
               ...
               @foreach($total_customers as $connected_cust)
                  <tr style="background-color: #e8dbca;" align="left">
                      ...
                      <td style="padding: 10px; color: black;">{{$connected_cust->customer_id}}</td>
                      <td style="padding: 10px; color: black;">{{$connected_cust->clients}}</td>
                      <td style="padding: 10px; color: black;">{{$connected_cust->service_plan}}</td>
                      <td style="padding: 10px; color: black;">{{$connected_cust->service_type}}</td>
                      <td style="padding: 10px; color: black;">{{$connected_cust->created_at}}</td>
                      @if($connected_cust->status=='Active')
                          <td style="padding: 10px; color: black;  background-color: #8febab">{{$connected_cust->status}}</td>
                      @elseif($connected_cust->status=='Inactive')
                          <td style="padding: 10px; color: black;  background-color: yellow">{{$connected_cust->status}}</td>
                      @else
                          <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$connected_cust->status}}</td>
                      @endif
