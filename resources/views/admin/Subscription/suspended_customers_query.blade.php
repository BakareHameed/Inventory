...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Suspended Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Suspended Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
          ...
          <table border=1 align='center'  style= "margin-bottom: 50px;">
			...
			@foreach($suspended_customers as $suspended_customers)
                <tr style="background-color: #e8dbca;" align="left">
                    ...
                    <td style="padding: 10px; color: black;">{{$suspended_customers->customer_id}}</td>
                    ...
                    <td style="padding: 10px; color: black;">{{$suspended_customers->created_at}}</td>
