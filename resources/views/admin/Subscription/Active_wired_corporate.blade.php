...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Active Wired Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Wired Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($wired_corporate as $wired_corporate)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$wired_corporate->customer_id}}</td>
                    <td style="padding: 10px; color: black;">{{$wired_corporate->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$wired_corporate->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$wired_corporate->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$wired_corporate->created_at}}</td>
                    @if($wired_corporate->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$wired_corporate->status}}</td>
                    @elseif($wired_corporate->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$wired_corporate->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$wired_corporate->status}}</td>
                    @endif
