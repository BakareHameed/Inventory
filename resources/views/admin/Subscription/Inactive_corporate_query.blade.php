...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Inactive Corporate Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Inactive Corporate Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
          ...
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($corporate as $corporate)
                <tr style="background-color: #e8dbca;" align="left">
                    ...
                    <td style="padding: 10px; color: black;">{{$corporate->customer_id}}</td>
                    <td style="padding: 10px; color: black;">{{$corporate->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$corporate->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$corporate->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$corporate->created_at}}</td>
                    @if($corporate->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$corporate->status}}</td>
                    @elseif($corporate->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$corporate->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$corporate->status}}</td>
                    @endif
