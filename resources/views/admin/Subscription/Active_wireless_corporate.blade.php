...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Active Wireless Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Wireless Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($wireless_corporate as $wireless_corporate)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$wireless_corporate->customer_id}}</td>
                    <td style="padding: 10px; color: black;">{{$wireless_corporate->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$wireless_corporate->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$wireless_corporate->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$wireless_corporate->created_at}}</td>
                    @if($wireless_corporate->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$wireless_corporate->status}}</td>
                    @elseif($wireless_corporate->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$wireless_corporate->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$wireless_corporate->status}}</td>
                    @endif
