...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Active Customers Between:</h2>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Clients  From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
          ...
          <table border=1 align='center'  style= "margin-bottom: 50px;">
            <tr style="background-color:black;">
              ...
              <tr style="background-color: #e8dbca;" align="left">
                  ...
                  <td style="padding: 10px; color: black;">{{$active_cust->customer_id}}</td>
                  <td style="padding: 10px; color: black;">{{$active_cust->clients}}</td>
                  <td style="padding: 10px; color: black;">{{$active_cust->service_plan}}</td>
                  <td style="padding: 10px; color: black;">{{$active_cust->service_type}}</td>
                  <td style="padding: 10px; color: black;">{{$active_cust->created_at}}</td>
                  @if($active_cust->status=='Active')
                      <td style="padding: 10px; color: black;  background-color: #8febab">{{$active_cust->status}}</td>
                  @elseif($active_cust->status=='Inactive')
                      <td style="padding: 10px; color: black;  background-color: yellow">{{$active_cust->status}}</td>
                  @else
                      <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$active_cust->status}}</td>
                  @endif
              </tr>
            @endforeach
		  </table>      	
