...
<div class="col-6 col-xl-6 col-xl-12 pl-0 text-center">
    <h2 style="font-size:20px">Get All Inactive Retail Customers Between:</h2>
    <form class="main-form" action="{{url('inactive_Home_customers_report')}}" method="GET" enctype="multipart/form-data">
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Inactive Retail Clients From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total Inactive Retail Clients</div>
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($Inactive_home as $Inactive_home)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$Inactive_home->customer_id}}</td>
                    <td style="padding: 10px; color: black;">{{$Inactive_home->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$Inactive_home->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$Inactive_home->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$Inactive_home->created_at}}</td>
                    @if($Inactive_home->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$Inactive_home->status}}</td>
                    @elseif($Inactive_home->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$Inactive_home->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$Inactive_home->status}}</td>
                    @endif
