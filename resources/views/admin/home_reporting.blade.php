          ...
          <div class="content-wrapper" style="background-color:#39d8e3">
            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal" style="font-size:30px">Total Pre Paid Customers</h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal" style="font-size:30px">Total Post Paid Customers</h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">Total Amount Paid for Pending Deployment Survey </h6>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="font-size:20px">Last Ten Surveys Created Between {{$dateS}} and {{$dateE}}</h4>
