...
<!--End of Multi-Level Navbar -->
  ...
  <div align="Center" style="padding:20px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">{{$pop_name}} POP Active Customers</h1>
    </div>
  </div>
  ...
  <div align="center" style="padding-left:15px;padding-right:15px;padding-top:30px">
    <table border=1 align="Center" style = "margin-bottom:30px">
      ...
      <tr style="background-color: white;" >
          ...
          <td style="padding: 10px; color: black;">{{$pop_detail->survey_id}}</td>
          ...
          <td style="padding: 10px; color: black;">{{$pop_detail->avg_speed}}{{$pop_detail->unit}}</td>
          @if($pop_detail->status=='Active')
            <td style="padding: 5px; color: black;  background-color: #8febab">{{$pop_detail->status}}</td>
          @elseif($pop_detail->status=='Inactive')
            <td style="padding: 5px; color: black;  background-color: yellow">{{$pop_detail->status}}</td>
          @else
            <td style="padding: 5px; color: black;  background-color: #fc6d6d ">{{$pop_detail->status}}</td>
          @endif
