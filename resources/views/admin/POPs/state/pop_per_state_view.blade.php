...
<body>
    ...
    <div class="col-xl-2 col-xl-2  mb-4" align="Center">
        <div class="card border-left-primary shadow h-100 py-2">
            ...
            <div class="row no-gutters align-items-center">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{count($pop_per_state)}} </div>
                </div>
                <div class="col-auto">
    ...
    <div class="col-xl-2 col-xl-2  mb-4" align="Center">
        <div class="card border-left-primary shadow h-100 py-2">
            ...
            <div class="row no-gutters align-items-center">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{count($total_client)}} </div>
                </div>
                <div class="col-auto">
                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                </div>
  ...
  <div align="Center" style="padding-top:10px;padding-bottom:10px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">POPs in {{$name}} State </h1>
    </div>
  </div>
  ...
  <div align="center" style="padding-right:30px;padding-top:10px;padding-bottom:30px">
    <table border=1 align='center'>
      ...
      @foreach($pop_per_state as $cl_state)
