...
<!--End of Multi-Level Navbar -->
  ...
  <div align="Center" style="padding:20px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">{{$name}} State Active Customers</h1>
    </div>
  </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{count($state)}} </div>
            </div>
            <div class="col-auto">
      ...
      <tr style="background-color:black;">
          ...
          @foreach($state as $cl_state)
            <tr style="background-color: #e8dbca;" align="left">
              ...
              <td style="padding: 5px; color: black;">{{$cl_state->id }}</td>
              <td style="padding: 5px; color: black; font-size: 25px; font-family:serif, sans serif, cursive, fantasy, and monospace"><strong>{{$cl_state->clients }}</strong></td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$cl_state->service_plan }}</td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$cl_state->service_type }}</td>
              ...
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$cl_state->created_at }}</td>
            </tr>
          @endforeach
    </table>      	
  </div>
