  ...
  <div align="Center" style="padding:20px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:2rem">
            {{$name}} State Active Customers from 
  ...
  <div align="center" style="padding-right:30px;padding-top:30px">
    <table border=1 align='center'>
      <tr style="background-color:black;">
          ...
          @foreach($state as $cl_state)
             @foreach ($cl_state as $prop => $value) 

            <tr style="background-color: #e8dbca;" align="left">
              <td>{{$loop->iteration}}</td>
              <td style="padding: 5px; color: black;">{{$value->customer_id }}</td>
              <td style="padding: 5px; color: black; font-size: 25px; font-family:serif, sans serif, cursive, fantasy, and monospace"><strong>{{$value->clients }}</strong></td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$value->service_plan }}</td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$value->service_type }}</td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace" >{{$value->location }}</td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$value->Region }}</td>
              <td style="padding: 5px; color: black;font-size: 20px; font-family:serif, sans serif, cursive, fantasy, and monospace">{{$value->created_at }}</td>
            </tr>
            @endforeach
          @endforeach
    </table>      	
