          ...
          <div class="content-wrapper" style="background-color:#39d8e3">
            ...
            <div align="Center" style="padding:0px">
              <div class="col-lg-6 py-3 wow fadeInUp text-center" >
                  <h2 class="text-center" style="text-align:center;font-size:2rem; color: Black; font-family:sans-serif"><strong> Total Number of Active Customers Per State</strong></h2>
              </div>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <a href="{{url('Clients_per_state_view',['state'=>$p_state->unique('location')->pluck('location')->implode(', ')] )}}" >
