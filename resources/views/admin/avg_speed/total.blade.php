    ...
    <div class="main-panel">
          ...
          <div align="Center" style="padding:20px">
            <div class="col-lg-6 py-3 wow fadeInUp text-center" >
                <h1 class="text-center" style="text-align:center;font-size:2rem; color:black">Active Clients Average Capacity</h1>
            </div>
          </div>
                      ...
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          ...
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                                ...
                                Mbps
                        <a  href="{{url('access-bandwidth-view')}}">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <a  href="{{url('speed_less_than_two')}}">
                        <div class= "icon icon-box-success" >
                          <span class="mdi mdi-arrow-top-right icon-item"></span>
                        </div>
                      </a> 
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <a  href="{{url('speed_btw_greater_than_ten')}}">
                        <div class= "icon icon-box-success" >
                          <span class="mdi mdi-arrow-top-right icon-item"></span>
                        </div>
                      </a>    
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:50px">{{number_format($Corporate_avg_speed)}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                        </div>
                      </div>
                                Mbps
                     </div>
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">Corporate Clients' Average Speed</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:50px">{{number_format($Shared_avg_speed)}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                        </div>
                      </div>
                                Mbps
                     </div>
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">Shared Clients' Average Speed</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:50px">{{number_format($Dedicated_avg_speed)}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                        </div>
                      </div>
                                Mbps
                     </div>
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">Dedicated Clients Average Speed</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:50px">{{number_format($SME_avg_speed)}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                        </div>
                      </div>
                                Mbps
                     </div>
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">SME Average Speed</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:50px">{{number_format($Home_avg_speed)}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                        </div>
                      </div>
                                Mbps
                     </div>
                    <h6 class="text-muted font-weight-normal" style="font-size:25px">Home Clients Average Speed</h6>
                  </div>
                </div>
              </div>
