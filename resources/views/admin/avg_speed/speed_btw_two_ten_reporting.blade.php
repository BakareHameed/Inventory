...
<body>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Clients With Speed between  2MBps and 10MBps From {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($deca_customers as $deca_customers)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$deca_customers->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$deca_customers->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$deca_customers->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$deca_customers->avg_speed}}{{$deca_customers->unit}}</td>
                    @if($deca_customers->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$deca_customers->status}}</td>
                    @elseif($deca_customers->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$deca_customers->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$deca_customers->status}}</td>
                    @endif
