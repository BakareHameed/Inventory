...
<body>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Clients With Speed less than 2mbps
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($half_customers as $half_customers)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$half_customers->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$half_customers->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$half_customers->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$half_customers->avg_speed}}{{$half_customers->unit}}</td>
                    @if($half_customers->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$half_customers->status}}</td>
                    @elseif($half_customers->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$half_customers->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$half_customers->status}}</td>
                    @endif
