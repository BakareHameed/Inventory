...
<body>
    ...
    <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-light shadow-sm" style ="background-color:#dff1f5">
        <div class="container">
    ...
    <div align="Center" style="padding:0px">
      <div class="col-lg-6 py-3 wow fadeInUp text-center" >
          ...
          All Active Clients' Bandwidth
        </h1>
      </div>
    </div>
    <div class="container" align="text-center" style="padding-top: 5px;">
        <div class="row px-5">
            <div class="col-sm-3 col-sm-3  mb-2">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total Clients</div>
            ...
            <div class="col-sm-3  mb-2">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-info text-uppercase mb-1">Total Bandwidth</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                      {{$sum}}
                                     </div>
                                    </div>
    ...
    <div align="center" style="margin-left:15px;padding-top:30px">
        <table border=1 align='center' style= "margin-bottom: 50px;">
            <tr style="background-color:black;">
                ...
                <th style="padding:20px; font-size: 20px; color: white ;text-alignment:left">ID</th>
                ...
                <th style="padding:20px; font-size: 20px; color: white ;">Bandwidth</th>
                <th style="padding:20px; font-size: 20px; color: white ;">Status</th>
            </tr>
            @foreach($total_customers as $total_customers)
              <tr style="background-color: #e8dbca;" align="left">
                  <td>{{$loop->iteration}}</td>
                  <td style="padding: 10px; color: black;">{{$total_customers->client_id}}</td>
                  <td style="padding: 10px; color: black;">{{$total_customers->clients}}</td>
                  <td style="padding: 10px; color: black;">{{$total_customers->service_plan}}</td>
                  <td style="padding: 10px; color: black;">{{$total_customers->service_type}}</td>
                  <td style="padding: 10px; color: black;">{{$total_customers->avg_speed}}{{$total_customers->unit}}</td>
                  @if($total_customers->status=='Active')
                      <td style="padding: 10px; color: black;  background-color: #8febab">{{$total_customers->status}}</td>
                  @elseif($total_customers->status=='Inactive')
                      <td style="padding: 10px; color: black;  background-color: yellow">{{$total_customers->status}}</td>
                  @else
                      <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$total_customers->status}}</td>
                  @endif
