...
<body>
 ...
 <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        ...
        All Active Clients With Speed greater than 10MBps
      </h1>
    </div>
</div>
    ...
    <div class="container" align="text-center" style="padding-top: 5px;">
        ...
        <div align="center" style="margin-left:15px;padding-top:30px">
          <table border=1 align='center' style= "margin-bottom: 50px;">
			...
			@foreach($duodeca_customers as $duodeca_customers)
                <tr style="background-color: #e8dbca;" align="left">
                    <td>{{$loop->iteration}}</td>
                    <td style="padding: 10px; color: black;">{{$duodeca_customers->clients}}</td>
                    <td style="padding: 10px; color: black;">{{$duodeca_customers->service_plan}}</td>
                    <td style="padding: 10px; color: black;">{{$duodeca_customers->service_type}}</td>
                    <td style="padding: 10px; color: black;">{{$duodeca_customers->avg_speed}}{{$duodeca_customers->unit}}</td>
                    @if($duodeca_customers->status=='Active')
                        <td style="padding: 10px; color: black;  background-color: #8febab">{{$duodeca_customers->status}}</td>
                    @elseif($duodeca_customers->status=='Inactive')
                        <td style="padding: 10px; color: black;  background-color: yellow">{{$duodeca_customers->status}}</td>
                    @else
                        <td style="padding: 10px; color: black;  background-color: #fc6d6d ">{{$duodeca_customers->status}}</td>
                    @endif
