<div class="main-panel">
    ...
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:30px;font-family: Verdana, Arial, Tahoma, Serif;">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <a href="{{url('raised-surveys-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                         <a href="{{url('done-surveys-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                         <a href="{{url('feasible-surveys-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                         <a href="{{url('Notfeasible-surveys-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                         <a href="{{url('installations-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                         <a href="{{url('pending-surveys-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-3">
                        <a href="{{url('pending-installations-query',['dateS'=>$dateS,'dateE'=>$dateE])}}">
                          <div class="icon icon-box-success " >
                            <span class="mdi mdi-arrow-top-right icon-item"></span>
                          </div>
                        </a>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    Surveys & Installation Statistics for Each 
                    Engineer from {{Carbon\Carbon::parse($dateS)->format('D, M j, Y')}}
