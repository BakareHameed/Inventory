  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
      <h1 class="text-center" style="text-align:center;font-size:2rem; color:black">
          <strong style="color: white"> Subscription For The Year {{Carbon\Carbon::parse($dcm)->format('Y')}} </strong>
      </h1>
    </div>
  </div>
      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title" style="font-size:20px">
            Subscription Statistics as at {{Carbon\Carbon::parse($dcm)->format(' F,Y')}}
              ...
              <div class="py-0 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden sm:rounded-lg">
                  <table class="columns min-w-full text-sm text-gray-400">
                    <tr>
                      <td>  
                        <div id="piechart_3d" style="width: 70rem; height: 41rem;color: white ;background-color:white: 20px; margin:30px"></div>
                      </td>
                    <tr>
                    <tr>
                      <td>  
