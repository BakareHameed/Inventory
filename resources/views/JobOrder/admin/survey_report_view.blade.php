<div class="modal fade" id="Surveys{{$client->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Raise{{$client->id}}Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="Surveys{{$client->id}}Label"><span style="color:blue;align:right"><strong>Survey Report<strong></span></h1>
                            ...
                            <table class="city">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong style="color:black;">L-N</strong> = {{ $client->LN }} <strong style="color:black;">L-E</strong> = {{ $client->LE }} <strong style="color:black;">E-N</strong> = {{ $client->EN }}</td>
                                    </tr>

                                    <tr>
                                        <td style="color:black;">Secondary source voltage</td>
                                        <td style="color:black;">{{ $client->sec_src_volt }} </td>
                                    </tr>

                                    <tr>
                                        <td style="color:black;">UPS Availability</td>
                                        <td style="color:black;">{{ $client->ups }} </td>
                                    </tr>

                                    <tr>
                                        <td style="color:black;">UPS power rating/current load (%)</td>
                                        <td style="color:black;">{{ $client->ups_power }} </td>
                                    </tr>

                                    <tr>
                                        <td style="color:black;">Power Extension</td>
                                        <td style="color:black;">{{ $client->power_ext }}</td>
                                    </tr>

                                    <tr>
                                        <td style="color:black;">Conducive Environment</td>
                                        <td style="color:black;">{{ $client->env }}</td>
                                    </tr>
                                </tbody>
