...
<!-- Beginning of script for Vetting Form by Service Operations Team Lead -->
    <script type="text/javascript">
    function comment_form(client_id){
        console.log('comment' + client_id);
        var form = document.getElementById("comment"+client_id);
...
<!-- End of Script For Vetting form -->
</body>
</html>