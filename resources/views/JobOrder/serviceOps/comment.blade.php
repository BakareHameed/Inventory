                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div style="overflow-x:auto;" class="p-6 bg-white border-b border-gray-200">
                                <div class="text-xl">
                                    ...
                                    located at
                                    <span class="text-yellow-600">{{ $client->address }}</span>, raised on <span class="text-yellow-600">{{Carbon\Carbon::parse($client->created_at)->format('D, M j, Y g:i A')}}</span>, raised by Engineer
                            ...
                            <div>
                                <div class="mt-5">
                                    ...
                                    <div class="pt-0"> <a type="button" class="btn btn-primary" id="btn" onclick="comment_form('{{ $client->id }}');" style="padding: 10px; color: white;background-color:black" href="#">Comment box</a></div>
                                </div>
                            </div>
                            @include('JobOrder.serviceOps.comment_form')
                            @elseif( Auth::user()->role === 'Admin Manager')
                            <div>
                                <div class="mt-5">
                                    <div class="font-bold">Approve:</div>
                                    <div class="pt-0"> <a type="button" class="btn btn-primary" id="btn" onclick="approval_form('{{ $client->id }}');" style="padding: 10px; color: white;background-color:black" href="#">Show Form</a></div>
                                </div>
                            </div>
                            @include('JobOrder.admin.approvalForm')
                            @endif
