...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm"  style="background-color: #e3f2fd;">
      ...
      <form action="{{url('find_customers_search')}}" method="GET" class="d-flex">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="contact.html">Contact</a>
               ...
               @if(Auth::user()->role=='Support Representative')
               <li class="nav-item">
               ...
               @elseif(Auth::user()->role=='Delivery Engineer' || Auth::user()->role=='Admin Manager')
              ...
              <li class="nav-item">
                ...
                @elseif(Auth::user()->role=='Network Operation Engineer')
                <li class="nav-item">
                <div class="btn-group" style="background-color: greenyellow; color: white;">
                <button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                  Networks
...
<div>
  <div class="col-sm-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center;font-size:1.5rem">Filter According to Other POPs</h1>
  </div>
    ...
    <div >
<div class="row">
<div class="col-sm-2 col-md-2  mb-2" style="padding-left:10px;margin-left:50px">
 <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> Total No. of Clients</div>
  ...
  <div align="Center" style="padding:0px">
    <div class="col-lg-6 py-3 wow fadeInUp text-center" >
        <h1 class="text-center" style="text-align:center; font-size: 30px;">All Clients In {{$pop}} POP</h1>
    </div>
</div>
  ...
  <table border=1 align="Center">
    ...
    @foreach($appointments as $appointment)
       ...
       @if(Auth::user()->role=='Delivery Engineer')
        <td> <a style="padding: 5px;margin-bottom:5px" class="btn btn-secondary" href="{{url('edit_customer',$appointment->survey_id)}}">Edit</a>
        </td>  
        @elseif(Auth::user()->role=='Admin Manager')
        <td> <a style="padding: 5px;margin-bottom:5px" class="btn btn-secondary" href="{{url('edit_customer',$appointment->survey_id)}}">Edit</a>
        </td> 
        @elseif(Auth::user()->role==	'Service Engineer')
        <td> <a style="padding: 20px;margin-bottom:20px;align:center" class="btn btn-secondary" href="{{url('edit_radio_parameters',$appointment->id)}}">Edit</a>
        </td>
      @else
